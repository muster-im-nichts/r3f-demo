...
export const eisfahrt: Campaign = {
  ...
  nodes: {
    ...
    'e-fabrik': {
      ...
      scene: 'fabrik',
      text: {
        default: 'Der Brigadier hört zu und wischt sich die Hände am Lappen ab.',
      },
      dialog: [
        {
          by: 'brigadier',
          line: {
            default:
              'Brechen? Vergiss es. Und unser Autokran wiegt zwölf Tonnen — der bricht euch ein, ehe er am Ufer steht.',
          },
        },
        { by: 'narrator', line: { default: 'Er tippt dir an die Brust.' } },
        {
          by: 'brigadier',
          line: {
            default:
              'Aber Eis trägt, wenn man die Last verteilt. Bohlen als Laufstege, viele kleine Fuhren mit Schlitten. Holz hat die alte Mühle, Schlitten hat halb Eberswalde.',
          },
        },
      ],
      options: [
    ...
    'e-muehle': {
      ...
      text: {
        default:
          'Der Müller versteht sofort und stemmt schon das Tor auf: Im Gebälk lagern Bohlen, breit und trocken, dazu Seile und zwei Leitern.',
      },
      dialog: [
        {
          by: 'mueller',
          line: {
            default: 'Nehmt alles. Und legt die Stege doppelt, wo der Kahn liegt — dort drückt die Last am meisten.',
          },
        },
        {
          by: 'narrator',
          line: { default: 'Arm um Arm wandern die Bretter auf die Schultern der Träger.' },
        },
      ],
      options: [
