...
export const STYLE = {
  scene:
    ...
    'moody theatrical night lighting, wide shot at street level, empty scene, ' +
    'no people, no animals, no text, no watermark',
  // Ohne eigenen Vorspann drückt "street level" Innenräume nach draußen
  sceneInterior:
    'fine pixel art, 16-bit hi-bit style, point-and-click adventure game background, ' +
    'in the style of classic SCUMM adventures, painterly dithering, muted palette, ' +
    'moody dim interior lighting, wide interior shot at eye level, room seen from inside, ' +
    'empty room, no people, no animals, no text, no watermark',
  character:
    'fine pixel art, 16-bit hi-bit style, full-body adventure game character sprite, ' +
    'standing idle in relaxed pose, three-quarter view facing right, whole figure ' +
    'visible from head to feet, feet at the bottom edge, centered, ' +
...
export const SCENES = [
  ...
  { key: '1760-gasse', epoch: 1760, seed: 176004,
    prompt: 'narrow fishermen alley at night, crooked timber-framed houses leaning together, hanging fishing nets, wet cobblestones, single lantern' },
  ...
  { key: '1860-bahnhof', epoch: 1860, seed: 186002,
    prompt: 'small railway station platform at night, steam locomotive with glowing firebox, gas lamps, luggage carts, smoke and fog' },
  ...
  { key: '1860-gasse', epoch: 1860, seed: 186004,
    prompt: 'narrow fishermen alley at night, brick and timber houses, gas lantern, wet cobblestones, hanging fishing nets' },
  ...
  { key: '1860-kanal', epoch: 1860, seed: 186006,
    prompt: 'industrial canal at night, iron footbridge, moored barges, factory chimneys in the distance, gas lantern reflections on water' },
  ...
  { key: '1960-fabrik', epoch: 1960, seed: 196002, interior: true,
    prompt: 'crane factory hall interior, huge steel crane parts, welding sparks glow, industrial lamps, banners on the wall' },
  ...
  { key: '1960-gasse', epoch: 1960, seed: 196004,
    prompt: 'narrow old alley at night, brick houses with crumbling plaster, single electric street lamp, bicycles leaning on the wall' },
  ...
  { key: '1960-kanal', epoch: 1960, seed: 196006,
    prompt: 'frozen industrial canal at night, ice on the water, moored coal barge, cranes and chimneys behind, cold blue street lamps' },
...
export const CHARACTERS = [
  // Spielfiguren
  { key: 'greta', seed: 900201, // 900001: Blick nach links
  ...
  { key: 'wilhelm', seed: 900202, // 900002: Blick nach links
  ...
  { key: 'lotte', seed: 900203, flip: true, // gutes Bild, Blick nach links
  ...
  { key: 'npc-junge', seed: 900206, pixelate: 2, // Flux liefert ihn weich — Raster erzwingen
  ...
  { key: 'npc-schaffner', seed: 900207, pixelate: 2, // Flux liefert ihn weich — Raster erzwingen
